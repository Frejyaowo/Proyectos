...
uint32_t clave = 0xA2F56789;
uint32_t valorcounter;
uint32_t  x;
uint16_t a;
uint32_t tiempo;
char texto[20];
...
int main(void)
{
 ...
 // HAL_ADC_Start_DMA(&hadc1,ADC_t,1);
 ...
 // GPIOA, GPIO_PIN_1
  ...
  while (1)
  {
	      ...
	      valorcounter =(uint32_t) __HAL_TIM_GET_COUNTER(&htim2);
